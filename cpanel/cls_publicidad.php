...
class Registro extends MantixBase {
    ...
    function formulario() {
        ...
        $m_Form->controles = array(
            ...
            array("label" => "Imagen Publicidad Top:", "campo" => "recurso", "tipo" => "archivogg",
                "descripcion" => "Imágenes Publicidad Top",
                "tooltip" => "Formatos perimtidos: jpg<br/>Tamaño: 960 x 90px",
                "extensiones" => "*.jpg",
            ),
            array("label" => "Publicidad:", "campo" => "recurso2", "tipo" => "archivogg",
                "descripcion" => "Imágenes JPG",
                "tooltip" => "Formatos perimtidos: jpg<br/>Tamaño: 778 x 977px",
                "extensiones" => "*.jpg"
            ),
    ...
    function lista() {
        $r = new MantixGrid();
        $sql = "select * from wee_publicidad where recurso3='' or recurso3 is null";
    ...
    function pre_del() {
        ...
        if ($_POST["cid"]) {
            ...
            while ($r = mysql_fetch_object($res)) {
                if ($r->recurso)
                    $rpt=unlink("../images/recursos/$r->recurso");
                if ($r->recurso2)
                    $rpt=unlink("../images/recursos/$r->recurso2");
                if ($r->recurso3)
                    $rpt=unlink("../images/recursos/$r->recurso3");
            }
        }else {
