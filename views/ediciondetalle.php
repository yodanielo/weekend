<?php
$ruta = $cfg["site"]["livesite"];
$ruta.='/images/recursos/' . $params["ed"]->flashlibro;
$ruta=str_replace(".swf", "", $ruta);
$width = 1650;
$height = 960;
$width = 1280;
$height = 817;
...
<div id="flashexplain" style="position:fixed;z-index:9999;width:100%; background: #F0F0F0;color: #006991;">Click en las esquinas superiores o arrastrarlas para navegar por las páginas.</div>
<div id="flashlibro" style="position:absolute;width:<?=$width?>px;height:<?=$height?>; position:absolute; left:50%; margin-left:-<?=ceil($width/2)?>px;">

</div>
<script language="JavaScript" type="text/javascript">
    $("#barrasecciones1 a:eq(4)").addClass("sec_selected");
<!--
//v1.7
...
function AC_Generateobj(objAttrs, params, embedAttrs)
{
  ...
  document.getElementById("flashlibro").innerHTML=(str);
...
if(hasRightVersion) {  // if we've detected an acceptable version
	...
	document.getElementById("flashlibro").innerHTML=(alternateContent);  // insert non-flash content
}
// -->
</script>
    </body>
